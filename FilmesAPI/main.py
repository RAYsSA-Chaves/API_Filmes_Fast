...
from schemas import MessageSchema, MovieDB, MovieList, MoviePublic, MovieSchema
...
@app.post('/filmes/', status_code=HTTPStatus.CREATED, response_model=MoviePublic)
...
@app.get('/filmes/{filme_id}', status_code=HTTPStatus.OK, response_model=MoviePublic)
...
@app.get('/filmes/', status_code=HTTPStatus.OK, response_model=MovieList)
def read_movies():
    return {'filmes': fake_db}

# Alterar um filme
@app.put('/filmes/{fime_id}', status_code=HTTPStatus.OK, response_model=MoviePublic)
...
# Deletar um filme
@app.delete('/filmes/{filme_id}', status_code=HTTPStatus.OK, response_model=MessageSchema)
